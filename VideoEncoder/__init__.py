...
database = os.environ.get("MONGO_URI" , mongosh "mongodb+srv://cluster0.Raja246442.mongodb.net/" --apiVersion 1 --username rajaRauthan")
...
owner = list(set(int(x) for x in os.environ.get("OWNER_ID" , "6184029705").split()))
